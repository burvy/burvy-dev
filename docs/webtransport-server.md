...
Note that this might be an issue and should be looked at, because for a chat room the
old messages shouldn't be deleted, but for something like a game room it should.
